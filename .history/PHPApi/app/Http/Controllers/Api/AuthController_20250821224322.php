    ...
    public function logout(Request $request)
    {
        try {
            ...
            if ($user) {
                ...
                if ($token) {
                    // Laravel Sanctum uses a specific hash method for tokens
                    // It's not just a simple SHA256, it includes the token ID
                    // So let's just delete all tokens for this user
