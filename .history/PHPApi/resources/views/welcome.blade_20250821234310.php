    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-8 text-white">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold mb-2">Ana Sayfa</h3>
                    <p class="text-blue-100 mb-2">E-ticaret sitesi için:</p>
                    <a href="/" class="inline-block bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
                        🏠 Ana Sayfaya Git
                    </a>
                </div>
                <div>
                    <h3 class="text-lg font-semibold mb-2">Giriş/Kayıt</h3>
                    <p class="text-blue-100 mb-2">Kullanıcı işlemleri için:</p>
                    <div class="space-y-2">
                        <a href="/login" class="inline-block bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
                            🔐 Giriş Yap
                        </a>
                        <a href="/register" class="inline-block bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
                            ✨ Kayıt Ol
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    <p class="text-blue-100 mb-2">Kullanıcı paneli için:</p>
